...
Before this lesson, you will need to download two zipped files and place them in the specified folder:
...
Find this by pressing `Windows Logo Key` + `R` (run dialog) and entering `cmd`. In Windows, the 
commands above to access the folder in your Desktop become:
