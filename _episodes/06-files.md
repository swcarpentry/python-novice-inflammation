...
![Three plots are generated by the code applied to inflammation-01.csv. 
The centre plot with the y-label max is triangular.  
The other two plots are jagged triangles.](../fig/03-loop_49_1.png)
...
![Three plots are generated by the code applied to inflammation-2.csv.  
They are similar to the last image, but the detailed shape of the jagged 
triangles is different, reflecting the different data in the file](../fig/03-loop_49_3.png)
