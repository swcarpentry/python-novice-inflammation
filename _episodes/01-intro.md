...
>
> A variable is comparable to a sticky note with a name written on it:
> assigning a value to a variable is like assigning that sticky note on a particular value.
>
...
> For example, let us store the subject's weight in pounds in its own variable:
>
> ~~~
