...
~~~
# offset_mean(data, target_mean_value): return a new array containing the original data 
...
in loadtxt(fname, dtype, comments, delimiter, converters, skiprows, usecols, unpack, ndmin)
    775     try:
