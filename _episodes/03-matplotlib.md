...
![Heat map representing the 'data' variable matrix. Each cell is colored by value along a color gradient from blue to yellow.](../fig/inflammation-01-imshow.svg)
