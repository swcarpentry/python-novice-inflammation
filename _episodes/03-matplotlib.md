...
![Heatmap representing the 'data' variable matrix. Each cell is coloured by value along a colour gradient from blue to yellow.](../fig/inflammation-01-imshow.svg)
