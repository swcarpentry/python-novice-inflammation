...
In Python, we can think of a string as an ordered collection of characters. We
can access a character in a string using its index. For example, we can get the first
