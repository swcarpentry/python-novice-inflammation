...
>
> [![x is represented as a pepper shaker containing several packets of pepper. [x[0]] is represented as a pepper shaker containing a single packet of pepper. x[0] is represented as a single packet of pepper. x[0][0] is represented as single fragment of pepper spice.  Adapted from @hadleywickham.](../fig/indexing_lists_python.png)][hadleywickham-tweet]
>
