...
In the episode "Visualizing Tabular Data", we wrote Python code that plots values of interest from our first
...
2.  **Difficult to maintain**. If we wanted to include some additional text for each list element,
    we would have to change four lines of code. While
...
>
>
> In the example above, the loop variable was given the name `number` since that describes the list contents;
